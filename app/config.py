...
QDRANT_COLLECTION = os.getenv("QDRANT_COLLECTION", "thesis_chunks")
QDRANT_VECTOR_SIZE = int(os.getenv("QDRANT_VECTOR_SIZE", "1024"))
QDRANT_DISTANCE = os.getenv("QDRANT_DISTANCE", "Cosine")
QDRANT_API_KEY = os.getenv("QDRANT_API_KEY", "")
QDRANT_BACKUP_DIR = os.getenv("QDRANT_BACKUP_DIR", "data/qdrant_backups")
MILVUS_URI = os.getenv("MILVUS_URI", "http://127.0.0.1:19530")
MILVUS_TOKEN = os.getenv("MILVUS_TOKEN", "")
MILVUS_COLLECTION = os.getenv("MILVUS_COLLECTION", "thesis_chunks")
MILVUS_VECTOR_SIZE = int(os.getenv("MILVUS_VECTOR_SIZE", "1024"))
MILVUS_METRIC_TYPE = os.getenv("MILVUS_METRIC_TYPE", "COSINE")
MILVUS_BACKUP_DIR = os.getenv("MILVUS_BACKUP_DIR", "data/milvus_backups")
